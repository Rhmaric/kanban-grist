...
URL à coller dans Grist (vue personnalisée → URL personnalisée) : `https://<compte>.github.io/kanban-grist/` (pour ce dépôt : [https://rhmaric.github.io/kanban-grist/](https://rhmaric.github.io/kanban-grist/)).

Accorder l'accès **document complet**, requis pour créer, déplacer et supprimer des cartes.
...
La CSP du Kanban autorise en plus `img-src https:` et `frame-src https:` pour la visionneuse de pièces jointes, servies par l'instance Grist dont le domaine n'est pas connu à l'avance. Voir la section [Sécurité](../README.md#sécurité) du README principal.
